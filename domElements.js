...
export const confirmDeleteModalEl = document.getElementById('confirmDeleteModal');
export const deleteItemNameEl = document.getElementById('deleteItemName');
export const confirmDeleteButton = document.getElementById('confirmDeleteButton');
...
export const exportPdfButton = document.querySelector('button[onclick="exportToPDF()"]'); // Sera utilisé pour attacher un listener
export const exportExcelButton = document.querySelector('button[onclick="exportToExcel()"]'); // Sera utilisé pour attacher un listener
